...
/**
 *  A node that defines a list view.  The {@link com.codename1.rad.ui.EntityEditor} will render a list using {@link com.codename1.rad.ui.entityviews.EntityListView}.
 *  
 *  == Supported Attributes
 *  
 *  . {@link ListCellRendererAttribute} - Specify the list cell renderer to use with this list.
 *  . {@link RowTemplateNode} - A node that is used by the {@link ListCellRendererAttribute} for each row.
 *  
 *  = Example
 *  
 ...
 *  And the result is
 *  
 *  image::doc-files/ContactList.png[]
 *  
...
public class ListNode extends Node {
	...
	public ListNode(com.codename1.rad.models.Attribute[] atts) {
	}
